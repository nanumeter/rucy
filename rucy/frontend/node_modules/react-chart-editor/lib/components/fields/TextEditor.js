  ...
  _createClass(UnconnectedTextEditor, [{
    ...
    value: function render() {
      ...
      if (latexOnly) {
        ...
        editor = _react2.default.createElement(_LaTeX2.default, {
          value: fullValue,
          placeholder: placeholder,
          onChange: updatePlot
        });
      } else if (richTextOnly) {
        editor = _react2.default.createElement(_RichText2.default, {
          value: fullValue,
          placeholder: placeholder,
          onChange: updatePlot
        });
        ...
        editor = _react2.default.createElement(_HTML2.default, {
          value: fullValue,
          placeholder: placeholder,
          onChange: updatePlot
        });
      } else {
        editor = _react2.default.createElement(_MultiFormat2.default, {
          value: fullValue,
          placeholder: placeholder,
          onChange: updatePlot
        });

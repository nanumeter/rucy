...
var UnconnectedDataSelector = exports.UnconnectedDataSelector = function (_Component) {
  ...
  _createClass(UnconnectedDataSelector, [{
    ...
    value: function setLocals(props, context) {
      ...
      this.is2D = false;
      if (props.container) {
        this.is2D = props.attr === 'z' && ['contour', 'contourgl', 'heatmap', 'heatmapgl', 'surface', 'carpet', 'contourcarpet'].includes(props.container.type) || props.container.type === 'table' && props.attr !== 'columnorder';
      }
    }
  }, {
    key: 'updatePlot',

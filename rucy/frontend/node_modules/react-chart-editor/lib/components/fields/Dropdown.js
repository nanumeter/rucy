...
exports.UnconnectedDropdown = undefined;
...
var UnconnectedDropdown = exports.UnconnectedDropdown = function (_Component) {
  _inherits(UnconnectedDropdown, _Component);

  function UnconnectedDropdown() {
    _classCallCheck(this, UnconnectedDropdown);

    return _possibleConstructorReturn(this, (UnconnectedDropdown.__proto__ || Object.getPrototypeOf(UnconnectedDropdown)).apply(this, arguments));
  }
...
UnconnectedDropdown.propTypes = _extends({
...
exports.default = (0, _lib.connectToContainer)(UnconnectedDropdown);

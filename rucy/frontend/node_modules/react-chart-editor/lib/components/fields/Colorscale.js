...
var Colorscale = function (_Component) {
  _inherits(Colorscale, _Component);

  function Colorscale(props) {
    _classCallCheck(this, Colorscale);

    var _this = _possibleConstructorReturn(this, (Colorscale.__proto__ || Object.getPrototypeOf(Colorscale)).call(this, props));
  ...
  _createClass(Colorscale, [{
    key: 'onUpdate',
    value: function onUpdate(colorscale) {

...
var operations = {
  inequality: [{ value: '!=', label: 'Target ≠ Reference' }, { value: '<', label: 'Target < Reference' }, { value: '<=', label: 'Target ≤ Reference' }, { value: '=', label: 'Target = Reference' }, { value: '>', label: 'Target > Reference' }, { value: '>=', label: 'Target ≥ Reference' }],
  inrange: [{ value: '[]', label: 'Lower ≤ Target ≤ Upper' }, { value: '()', label: 'Lower < Target < Upper' }, { value: '[)', label: 'Lower ≤ Target < Upper' }, { value: '(]', label: 'Lower < Target ≤ Upper' }],
  exrange: [{ value: ')(', label: 'Lower ≤ Target ≤ Upper' }, { value: '][', label: 'Lower < Target < Upper' }, { value: ')[', label: 'Lower ≤ Target < Upper' }, { value: '](', label: 'Lower < Target ≤ Upper' }],
  inset: [{ value: '{}', label: 'Include' }],
  exset: [{ value: '}{', label: 'Exclude' }]
};

var findOperation = function findOperation(operator) {
  var op = 'inequality';
  for (var key in operations) {
    if (operations.hasOwnProperty(key) && operations[key].map(function (o) {
      return o.value;
    }).indexOf(operator) !== -1) {
      op = key;
      break;
...
var UnconnectedFilterOperation = function (_Component) {
  ...
  function UnconnectedFilterOperation(props, context) {
    ...
    _this.state = {
      operation: findOperation(_this.props.fullValue),
  ...
  _createClass(UnconnectedFilterOperation, [{
    ...
    value: function setOperation(value) {
      var operator = operations[value][0].value;
...
var UnconnectedFilterValue = function (_Component2) {
  ...
  _createClass(UnconnectedFilterValue, [{
    ...
    value: function setValue(v) {
      var op = findOperation(this.context.container.operation);
    ...
    value: function render() {
      ...
      var op = findOperation(operation);

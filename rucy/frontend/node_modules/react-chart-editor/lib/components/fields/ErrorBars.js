    ...
    value: function renderModeSelector() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(_RadioBlocks2.default, {
          ...
          options: [{ label: _('Symmetric'), value: 'symmetric' }, { label: _('Asymmetric'), value: 'asymmetric' }, { label: _('Hidden'), value: 'hidden' }]
        })
      );
    }
  }, {
    ...
    value: function renderErrorBarControls() {
      ...
      if (mode === 'symmetric') {
        return _react2.default.createElement(
          ...
          showCustomDataControl ? _react2.default.createElement(_index.DataSelector, {
            label: _('Custom Data'),
      ...
      if (mode === 'asymmetric') {
        return _react2.default.createElement(
          ...
          _react2.default.createElement(_index.Numeric, { label: _('Value'), attr: this.props.attr + '.value' }),
          _react2.default.createElement(_index.Numeric, {
            label: _('Value (-)'),
          ...
          showCustomDataControl ? _react2.default.createElement(
            _react.Fragment,
            null,
            _react2.default.createElement(_index.DataSelector, {
              label: _('Error (+)'),
              attr: this.props.attr + '.array'
            }),
            _react2.default.createElement(_index.DataSelector, {

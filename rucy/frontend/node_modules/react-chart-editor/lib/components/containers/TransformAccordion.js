...
var TransformAccordion = function (_Component) {
  ...
  _createClass(TransformAccordion, [{
    ...
    value: function render() {
      ...
      var transformTypes = [{ label: _('Filter'), type: 'filter' }, { label: _('Split'), type: 'groupby' }, { label: _('Aggregate'), type: 'aggregate' }];

      var transformableCharts = ['scatter', 'bar', 'scattergl', 'histogram', 'histogram2d', 'box', 'violin'];

      if (!transformableCharts.includes(fullContainer.type)) {
        return _react2.default.createElement(_FoldEmpty2.default, {
          icon: _plotlyIcons.PlotScatterIcon,
      ...
      var addAction = {
        label: _('Transform'),
        handler: transformTypes.map(function (_ref3) {

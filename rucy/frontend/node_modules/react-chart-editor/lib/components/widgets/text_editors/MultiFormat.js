...
var MultiFormatTextEditor = function (_Component) {
  ...
  _createClass(MultiFormatTextEditor, [{
    ...
    value: function renderEditor(render) {
      ...
      var richTextClassNames = (0, _classnames2.default)('multi-format-editor__tab', 'top-tab', 'left', { selected: currentTab === 'RICH_TEXT' });
      var latexClassNames = (0, _classnames2.default)('multi-format-editor__tab', 'top-tab', 'right', { selected: currentTab === 'LATEX' });

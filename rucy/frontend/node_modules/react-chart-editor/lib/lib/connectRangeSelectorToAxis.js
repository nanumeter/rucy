...
function connectRangeSelectorToAxis(WrappedComponent) {
  var RangeSelectorConnectedComponent = function (_Component) {
    ...
    function RangeSelectorConnectedComponent(props, context) {
      ...
      var _this = _possibleConstructorReturn(this, (RangeSelectorConnectedComponent.__proto__ || Object.getPrototypeOf(RangeSelectorConnectedComponent)).call(this, props, context));

      _this.deleteRangeselector = _this.deleteRangeselector.bind(_this);
    ...
    _createClass(RangeSelectorConnectedComponent, [{
      ...
      value: function getChildContext() {
        ...
        return {
          getValObject: function getValObject(attr) {
            return !_this2.context.getValObject ? null : _this2.context.getValObject('rangeselector.buttons[].' + attr);
          },
      ...
      value: function updateRangeselector(update) {
        ...
        for (var key in update) {
          var newkey = 'rangeselector.buttons[' + rangeselectorIndex + '].' + key;
  ...
  RangeSelectorConnectedComponent.displayName = 'RangeSelectorConnected' + (0, _lib.getDisplayName)(WrappedComponent);

  RangeSelectorConnectedComponent.propTypes = {
    rangeselectorIndex: _propTypes2.default.number.isRequired
  };

...
var chartCategory = exports.chartCategory = function chartCategory(_) {
  return {
    SIMPLE: {
      value: 'SIMPLE',
      label: _('Simple')
...
var categoryLayout = exports.categoryLayout = function categoryLayout(_) {
  return [chartCategory(_).SIMPLE, chartCategory(_).WEB_GL, chartCategory(_).DISTRIBUTIONS, chartCategory(_).SPECIALIZED, chartCategory(_).MAPS];
};

var traceTypes = exports.traceTypes = function traceTypes(_) {
  return [{
    value: 'scatter',
    label: _('Scatter'),
